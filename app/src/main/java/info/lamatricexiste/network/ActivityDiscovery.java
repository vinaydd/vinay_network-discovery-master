...
final public class ActivityDiscovery extends ActivityNet implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
         ...
         intent.putExtra("ip_address",host.ipAddress);
         intent.putExtra("mac_address",host.hardwareAddress);
         intent.putExtra("vendor_name",host.nicVendor);
